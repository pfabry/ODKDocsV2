 ...
 * [ODKDocsV2.yml](ODKDocsV2.yml)
     * Determines how your purl.obolibrary.org/obo/ODKDocsV2/ redirects will be handled
     ...
     * Paste in the contents of [ODKDocsV2.yml](ODKDocsV2.yml)
 ...
 * [ODKDocsV2.md](ODKDocsV2.md)
     ...
     * Paste in the contents of [ODKDocsV2.md](ODKDocsV2.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
